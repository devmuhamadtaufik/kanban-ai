<script lang="ts">
	...
	import BacklogView from '$lib/components/board/backlog-view.svelte';
...
<svelte:head>
	<title>Backlog | {siteConfig.name}</title>
</svelte:head>
...
>
	<div class="flex w-full items-center gap-1 px-4 lg:gap-2 lg:px-6">
		...
		<h1 class="text-base font-medium">Backlog</h1>
...
<div class="flex flex-1 flex-col overflow-hidden">
	<BacklogView boardId={selectedBoardId} />
</div>
